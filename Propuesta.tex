...
%Introducci\'on a la propuesta de Monograf\'ia. Debe incluir un breve resumen del estado del arte del problema a tratar. Tambi\'en deben aparecer citadas todas las referencias de la bibliograf\'ia (a menos de que se citen m\'as adelante, en los objetivos o metodolog\'ia, por ejemplo)
...
%Debido a la estructura relativamente simple de las nubes de gas que dan origen a la formaci\'on estelar es conveniente analizar estas acumulaciones para estudiar sus distintas propiedades f\'isicas y qu\'imicas [3]. \\
